# Running your own OpenRFP

This guide is for anyone hosting OpenRFP themselves: the stack, the accounts
you need, the database and email setup, guest-session limits, and the knobs
that control the evaluation model. If you only want to *use* OpenRFP, see the
[README](../README.md).
...
- No PDF export (CSV, JSON and HTML report only), no BYOK, no rubric templates.
